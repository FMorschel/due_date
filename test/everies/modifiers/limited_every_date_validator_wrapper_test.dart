...
import 'package:due_date/src/everies/modifiers/limited_every_date_validator_wrapper.dart';
...
class LimitedEveryDateValidatorWrapperTest
    extends LimitedEveryDateValidatorWrapper
    with
        LimitedEveryDateValidatorMixin,
        LimitedEveryModifierMixin,
        LimitedEveryMixin,
        DateValidatorMixin {
  const LimitedEveryDateValidatorWrapperTest({
    required EveryDateValidator super.every,
  }) : _every = every;
...
void main() {
  group('LimitedEveryDateValidatorWrapper', () {
    const every = LimitedEveryDateValidatorWrapperTest(
