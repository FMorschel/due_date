...
void main() {
  group('LimitedEveryTimeOfDayModifier:', () {
    ...
    group('Constructor', () {
      group('Unnamed', () {
        test('Valid basic case', () {
          expect(
            LimitedEveryTimeOfDayModifier(every: every),
            isNotNull,
          );
        });
        test('Can be created as constant', () {
          const modifier = LimitedEveryTimeOfDayModifier(
        ...
        test('Creates with custom everyTimeOfDay', () {
          ...
          final modifier = LimitedEveryTimeOfDayModifier(
            every: every,
    ...
    group('Methods', () {
      ...
      group('Limit handling', () {
        ...
        test('Accepts limit parameter in next', () {
          // July 1, 2024 at 10:00.
          final validDate = DateTime(2024, 7, 1, 10);
          // July 9, 2024 is after July 8.
          final limit = DateTime(2024, 7, 9);
        ...
        test('Throws when limit is reached in next', () {
          // July 1, 2024 at 10:00.
          final validDate = DateTime(2024, 7, 1, 10);
          // July 7, 2024 is before July 8.
          final limit = DateTime(2024, 7, 7);
          expect(
        ...
        test('Accepts limit parameter in previous', () {
          // July 8, 2024 at 10:00.
          final validDate = DateTime(2024, 7, 8, 10);
          // June 30, 2024 is before July 1.
          final limit = DateTime(2024, 6, 30);
        ...
        test('Throws when limit is reached in previous', () {
          // July 8, 2024 at 10:00.
          final validDate = DateTime(2024, 7, 8, 10);
          // July 2, 2024 is after July 1.
          final limit = DateTime(2024, 7, 2);
          expect(
        ...
        test('Limit exactly equals expected date in next', () {
          ...
          final validDate = DateTime(2024, 7, 1, 10);
          // July 8, 2024 at 10:00.
          final limit = DateTime(2024, 7, 8, 10);
          final result = modifier.next(validDate, limit: limit);
        ...
        test('Limit exactly equals expected date in previous', () {
          ...
          final validDate = DateTime(2024, 7, 8, 10);
          // July 1, 2024 at 10:00.
          final limit = DateTime(2024, 7, 1, 10);
          final result = modifier.previous(validDate, limit: limit);
          expect(result, equals(limit));
        });
      });
    ...
    group('Equality', () {
      final modifier1 = LimitedEveryTimeOfDayModifier(every: every);
      final modifier2 = LimitedEveryTimeOfDayModifier(every: every);
      const customTime = EveryDueTimeOfDay(Duration(hours: 14, minutes: 30));
      final modifier3 = LimitedEveryTimeOfDayModifier(
        every: every,
        everyTimeOfDay: customTime,
      );
      const differentEvery = EveryWeekday(Weekday.tuesday);
      final modifier4 = LimitedEveryTimeOfDayModifier(every: differentEvery);
