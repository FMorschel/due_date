...
/// {@template limited_every_skip_invalid_adapter}
...
/// {@endtemplate}
class LimitedEverySkipInvalidAdapter<T extends Every, V extends DateValidator>
    ...
    implements EverySkipInvalidAdapter<T, V> {
  /// {@macro limited_every_skip_invalid_adapter}
  const LimitedEverySkipInvalidAdapter({
  ...
  bool operator ==(Object other) {
    return (super == other) ||
        ((other is LimitedEverySkipInvalidAdapter) &&
            (other.every == every) &&
